...
test("server renders the PoB analyzer shell", async () => {
...
test("the starter preview is not part of the finished site", async () => {
  ...
  assert.match(page, /<Analyzer \/>/);
  assert.match(layout, /title:\s*"PoB Reality Check"/);
