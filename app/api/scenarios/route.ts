...
export async function POST(request: Request) {
  try {
    ...
    return NextResponse.json(buildScenarioReport({ configured: results.configured, unconditional: results.unconditional, peak: results.peak, burst: results.burst, initial: results.initial, mapping: results.mapping }, encounterSeconds, timeline));
  } catch (error) {
